...
pub struct SharePatientData<'info> {
    ...
    pub patient_data: Box<Account<'info, PatientData>>,
}
...
pub mod shingo_program {
    ...
    // --- Share medical records reproduction
    // Code from : https://github.com/arcium-hq/examples/blob/main/share_medical_records/programs/share_medical_records/src/lib.rs
